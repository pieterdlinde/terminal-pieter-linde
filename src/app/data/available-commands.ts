...
export class AvailableCommands {
  ...
  public static allCommands(): AvailableCommand[] {
    return [
      ...
      new AvailableCommand("about", "About Me", true),
      ...
      new AvailableCommand("date", "Display the current date", true),
      new AvailableCommand("echo", "Print a message", false),
      ...
      new AvailableCommand("quote", "Display a quote", true),
      ...
      new AvailableCommand("agify", "How old is your name?", true),
      ...
      new AvailableCommand("meow", "meow meow meow meow", true),
      ...
      new AvailableCommand("hobbies", "My hobbies", true),
    ]
  };
